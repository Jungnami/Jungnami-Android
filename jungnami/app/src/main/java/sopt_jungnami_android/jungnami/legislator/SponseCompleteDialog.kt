...
import kotlinx.android.synthetic.main.dialog_sponse_complete_popup.*
...
// made by YunHwan
class SponseCompleteDialog(val ctx : Context) : Dialog(ctx) {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        requestWindowFeature(Window.FEATURE_NO_TITLE)
        setContentView(R.layout.dialog_sponse_complete_popup)
        setClickListener()

    }
    private fun setClickListener(){
        sponse_popup_complete_check_btn.setOnClickListener {
            dismiss()
        }
    }
