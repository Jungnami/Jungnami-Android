...
class PartyDistrictLegislatorListViewAdapter(var context: Context, var legislatorItems: ArrayList<PartyDistrictLegistlatorListData>, var likeableFlage: Int) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return PartyDistrictLegislatorListViewHolder(view)
    }
