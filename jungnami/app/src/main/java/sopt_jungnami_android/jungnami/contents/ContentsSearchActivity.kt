...
class ContentsSearchActivity : AppCompatActivity(), View.OnClickListener {
    ...
    lateinit var ContentsSearchItems : List<ContentsSearchData>
    ...
    fun getContentsSearchresult(keyword : String){
        ...
        val getContentSearchResponse = networkService.getContentsSearchresult(keyword)
    ...
    private fun changeConetentsRecyclerViewData(){
        contentsSearchRecyclerViewAdapter = ContentsSearchRecyclerViewAdapter(context, ContentsSearchItems as ArrayList<ContentsSearchData>)
        Log.v("통신안", "들어오긴옴")
